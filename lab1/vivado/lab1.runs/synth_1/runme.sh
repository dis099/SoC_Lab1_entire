...
HD_PWD='/home/diezec/lab1/vivado/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_SoC_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_SoC_wrapper.tcl
