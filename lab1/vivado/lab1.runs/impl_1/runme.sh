...
HD_PWD='/home/diezec/lab1/vivado/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_SoC_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1_SoC_wrapper.tcl -notrace
