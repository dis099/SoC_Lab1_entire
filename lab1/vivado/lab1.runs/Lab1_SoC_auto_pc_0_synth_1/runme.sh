...
HD_PWD='/home/diezec/lab1/vivado/lab1.runs/Lab1_SoC_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_SoC_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_SoC_auto_pc_0.tcl
